...
<body>
	<div class="container-fluid">
		...
		<div class="row justify-content-center align-items-center" id="body">
			<div id="form" class="col-8 col-md-5 col-lg-4">
				<div class="row form-header">
					<span class="col-6">Information</span>
				</div>
				<div class="row input-area">
					<input type="text" id="name" placeholder="restaurant_name" class="col-12 steven-form-element steven-text-light" />
				</div>
				<div class="row input-area">
